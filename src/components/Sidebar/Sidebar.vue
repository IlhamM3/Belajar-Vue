    ...
    >
      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <a
                ...
                :class="[
                  isActive
                    ...
                    : 'text-blueGray-700 hover:text-gray-700',
                ]"
              >
                <i
          ...
          <li class="items-center">
              <button @click="logout" class="text-emerald-500 hover:text-emerald-600 uppercase py-3 font-bold block fas fa-tools mr-2 text-sm"
              >
                Logout
              </button >
          </li>
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="items-center">
            <router-link
              class="text-blueGray-700 hover:text-gray-700 text-xs uppercase py-3 font-bold block"
              to="#"
            >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="inline-flex">
            <a
              ...
              target="_blank"
              class="text-blueGray-700 hover:text-gray-700 text-sm block mb-4 no-underline font-semibold"
            >
              <i
