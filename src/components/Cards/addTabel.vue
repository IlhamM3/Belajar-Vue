    ...
    actions: {
        ...
        DoneTodo(index) {
            try {
                ...
                const statusdone = document.getElementById('status');
        ...
        todoEdit(input) {
            try {
                ...
                if (index > -1) {
                    ...
                    this.listtodo[index] = editedTodo; // Mengganti elemen pada index tertentu
                }
            } catch (error) {
                console.error(error);
                throw error;
